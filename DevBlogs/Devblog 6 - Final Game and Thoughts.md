...
## Game Loop
The current finalization of the game loop is as follows: the two players fight to the death whilst trying to climb the tower to avoid losing. The first player to lose all 3 lives loses the game.

Players can utilize weapon pickups to their advantage while also trying to overcome dangerous events, such as the boulder, which heavily punishes the player if not avoided, and flying demons that spawn after a certain amount of time, whether the players are prepared or not. Over time, the platforms also speed up, intensifying the entire situation and increasing the pressure on both players.
